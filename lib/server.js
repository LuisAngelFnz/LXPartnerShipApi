...
app.get('/v1/fizzbuzz/:score', (request, response)=>{
    console.log(`[${new Date()}] Api PartnerShip [M] GET [F] applyScoreValidationInNumber [P] ${request.params.score}`);
    const result = ExplorerController.applyScoreValidationInNumber(request.params.score)
    response.status(200).json({
